...
async function fetchAndConcatMetroData() {
    ...
    const estacionesMetroManuales = [
        ...
        { nombre: "Ángel Guimera", linea: "1,2,3,5,9", geo_point_2d: { lat: 39.47003489072011, lon: -0.386960698968137 } },
        { nombre: "Av. del Cid", linea: "3,5,9", geo_point_2d: { lat: 39.468564784795085, lon: -0.3984359700115798 } },
        { nombre: "Colon", linea: "3,5,7,9", geo_point_2d: { lat: 39.47013788930031, lon: -0.37091707511149846 } },
        { nombre: "Alameda", linea: "3,5,7,9", geo_point_2d: { lat: 39.47354999573717, lon: -0.3654445708817468 } },
        { nombre: "Facultats", linea: "3,9", geo_point_2d: { lat: 39.47825353393549, lon: -0.36186986161796886 } },
        ...
        { nombre: "Alboraya-Palmaret", linea: "3,9", geo_point_2d: { lat: 39.49566660101209, lon: -0.3551640278111203 } },
        { nombre: "Alboraya-Peris Aragó", linea: "3,9", geo_point_2d: { lat: 39.50072627305551, lon: -0.3523538858226942 } },
