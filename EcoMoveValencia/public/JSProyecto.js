...
function muestraRutaTaxi(){
  ...
  modal.style = `position:fixed;${window.innerWidth<=758?"top:10vh;left:5vw;width:90vw;font-size:4vw;":"top:10vh;right:20px;width:350px;font-size:16px;"}max-height:80vh;background:white;z-index:10000;overflow-y:auto;box-shadow:0 8px 16px rgba(0,0,0,0.25);border-radius:12px;padding:20px;font-family:Arial,sans-serif;`;
